...
class Game : NSObject, EZMicrophoneDelegate, EZAudioFFTDelegate {
    ...
    */
    ...
    func fft(fft: EZAudioFFT!, updatedWithFFTData fftData: UnsafeMutablePointer<Float>, bufferSize: vDSP_Length) {
        ...
        _ = EZAudioUtilities.noteNameStringForFrequency(fundamentalFrequency, includeOctave: false)
        
        let theNote = Note(frequency: Double(fundamentalFrequency))
        
        _ = Int(theNote.differenceInCentsToTrueNote) // Int just to get rid of decimal
